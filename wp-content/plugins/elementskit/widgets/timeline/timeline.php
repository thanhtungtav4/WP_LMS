...
class ElementsKit_Widget_timeline extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Icon text Color', 'elementskit' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
            ...
            if ( ! empty( $content['ekit_timeline_date_link']['url'] ) ) {
             ...
             if($settings['ekit_timeline_style'] == 'vertical') : ?>
                    ...
                    <div class="single-timeline media single-timeline-count-<?php echo esc_attr(($count+1)); ?> elementor-repeater-item-<?php echo esc_attr( $content[ '_id' ] ); ?>" >
                            <div class="timeline-item media<?php echo $this->has_animation('left'); ?>" data-settings="<?php echo esc_attr(json_encode($left_entranceAnimation)); ?>">
                            ...
                            <div class="timeline-info timeline-info-onside<?php echo $this->has_animation('right'); ?>" data-settings="<?php echo esc_attr(json_encode($right_entranceAnimation)); ?>">
                            ...
                            <?php endif;
                                ...
                                echo \ElementsKit_Lite\Utils::render( esc_html( $content['ekit_timeline_content_date'] ) ); ?> </h4>
                    ...
                    <?php if($settings['ekit_timeline_style'] == 'vertical' && $settings['ekit_timeline_vertical_style'] == 'bothside') : ?>
                     ...
                     <div class="timeline-info<?php echo $this->has_animation('right'); ?>" data-settings="<?php echo esc_attr(json_encode($right_entranceAnimation)); ?>">
                    <?php if($content['ekit_timeline_content_date'] != '') : ?>
                    ...
                    if($content['ekit_timeline_content_date'] != '') :
                     ...
                     <?php endif;
                               echo \ElementsKit_Lite\Utils::render( esc_html( $content['ekit_timelinehr_content_address'] ) ); ?> </p>
                     <?php endif; ?>
                      </div>
